...
@SuppressLint("NewApi")
class TileDynamicHzController : TileService(), ITileController {
    override fun onStartListening() {
        super.onStartListening()
        val tile = qsTile
        tile.label = getString(R.string.set_dynamic)
    ...
    override fun onClick() {
        super.onClick()
        setRefreshRate(RefreshRate.Dynamic)
        val tile = qsTile
        tile.state = Tile.STATE_ACTIVE
        tile.updateTile()
    ...
    override fun isCurrentRefreshRate(controller: TileService) :Boolean{
        ...
        return refreshRate.equals(RefreshRate.Dynamic.minRefreshRateValue)
    }
}
